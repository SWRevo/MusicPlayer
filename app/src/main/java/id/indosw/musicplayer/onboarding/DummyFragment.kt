package id.indosw.musicplayer.onboarding
...
class DummyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dummy, container, false).apply {
            ...
            findViewById<TextView>(R.id.fragment_textview).setOnClickListener {
                val intent = Intent (activity, ListLaguActivity::class.java)
