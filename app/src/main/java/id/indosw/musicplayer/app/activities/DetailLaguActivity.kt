...
package id.indosw.musicplayer.app.activities
...
class DetailLaguActivity : AppCompatActivity() {
    ...
    private var idLagu: String? = null
    private var modelListLagu: ModelListLagu? = null
    var progressDialog: ProgressDialog? = null
    var mHandler: Handler? = null
    var mRunnable: Runnable? = null
    var rotate: RotateAnimation? = null

    private var toolbar_detail: Toolbar? = null
    var imgPause: ImageView? = null
    var imgPlay: ImageView? = null
    var imgCover: ImageView? = null
    var tvTitleMusic: TextView? = null
    var tvBand: TextView? = null
    var seekBar: ArcSeekBar? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvTitleMusic = findViewById(R.id.tvTitleMusic)
